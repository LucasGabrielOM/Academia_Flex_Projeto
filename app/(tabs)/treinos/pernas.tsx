...
export default function Pernas() {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.card}>
        <Text style={styles.exercise}>Leg Press</Text>
        <Text style={styles.series}>4 séries — 10 a 12 rep</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.exercise}>Cadeira Extensora</Text>
        <Text style={styles.series}>3 séries — 12 a 15 rep</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.exercise}>Mesa Flexora</Text>
